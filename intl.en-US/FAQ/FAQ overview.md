...
|Type|Question|
|----|--------|
|[Pre-sales FAQ](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)|-   [Does Alibaba Cloud provide free Anti-DDoS services?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [Can Anti-DDoS Pro and Anti-DDoS Premium be billed only when they are triggered to mitigate DDoS attacks?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [Do Anti-DDoS services have trial mitigation plans?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [Can Anti-DDoS services protect external servers?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [Can Anti-DDoS Pro and Anti-DDoS Premium protect external servers that serve a domain name registered with Alibaba Cloud?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [Is Internet Content Provider \(ICP\) filing required for domain names that require the protection of Alibaba Cloud Anti-DDoS services?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [What are the regions supported by Anti-DDoS services?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [Do Anti-DDoS Pro and Anti-DDoS Premium have limits on the number of protected domain names?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [Do Anti-DDoS instances support wildcard domains?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [What are the prerequisites for setting up protection with Anti-DDoS Premium?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md)
-   [Does the basic protection bandwidth provided by an Anti-DDoS Pro instance indicate the maximum mitigation capacity?](/intl.en-US/Product Introduction on Alibaba DDoS Protection/Pre-sales FAQ.md) |
|[FAQ for the billing of burstable protection](/intl.en-US/FAQ/FAQ for the billing of burstable protection.md)|-   [Are burstable protection fees charged when no attacks are detected?](/intl.en-US/FAQ/FAQ for the billing of burstable protection.md)
-   [What is the maximum mitigation capacity if I purchase an Anti-DDoS instance with a basic protection bandwidth of 20 Gbit/s and a burstable protection bandwidth of 50 Gbit/s?](/intl.en-US/FAQ/FAQ for the billing of burstable protection.mdsection_e1g_n3h_ttq)
-   [What happens if the size of the DDoS attacks exceeds the burstable protection bandwidth?](/intl.en-US/FAQ/FAQ for the billing of burstable protection.md)
-   [How burstable protection is charged if the basic protection bandwidth is 30 Gbit/s, the burstable protection bandwidth is 50 Gbit/s, and the size of the DDoS attacks is 45 Gbit/s?](/intl.en-US/FAQ/FAQ for the billing of burstable protection.mdsection_uew_cwl_895)
-   [Can I change the burstable protection bandwidth from 100 Gbit/s to 200 Gbit/s?](/intl.en-US/FAQ/FAQ for the billing of burstable protection.mdsection_tbb_9xh_h9r)
...
-   [Can I manually deactivate the black hole status?](/intl.en-US/FAQ/Anti-DDoS Pro and Anti-DDoS Premium FAQ.mdsection_p5r_kk3_ocs)
...
-   [Are the back-to-origin CIDR blocks of Anti-DDoS Pro and Anti-DDoS Premium automatically added to a security group?](/intl.en-US/FAQ/Anti-DDoS Pro and Anti-DDoS Premium FAQ.mdsection_rob_5uy_808)
...
-   [Does the configuration of the origin server IP address for an Anti-DDoS Pro or Anti-DDoS Premium instance take effect immediately?](/intl.en-US/FAQ/Anti-DDoS Pro and Anti-DDoS Premium FAQ.mdsection_xrr_p7z_rki)
...
-   [How is traffic distributed to multiple origin servers protected by an Anti-DDoS Pro or Anti-DDoS Premium instance?](/intl.en-US/FAQ/Anti-DDoS Pro and Anti-DDoS Premium FAQ.mdsection_wel_rpm_7j6)
...
-   [Does Anti-DDoS Pro or Anti-DDoS Premium support mutual HTTPS authentication?](/intl.en-US/FAQ/Anti-DDoS Pro and Anti-DDoS Premium FAQ.mdsection_cfz_baq_wws)
...
-   [Which SSL protocols and cipher suites are supported by Anti-DDoS Pro or Anti-DDoS Premium?](/intl.en-US/FAQ/Anti-DDoS Pro and Anti-DDoS Premium FAQ.mdsection_kkt_vxb_72v)
