...
-   **Insurance Plan** 
    ...
    **Note:** To purchase more advanced mitigations, see [Global advanced mitigation](reseller.en-US/Anti-DDoS Premium Service/Pricing/Global advanced mitigation.md#).
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/79667/156515997935184_en-US.png)
...
## Pricing details of Anti-DDoS Premium {#section_ypr_vzu_aij .section}
...
|Number of protected domain names|The number of HTTP/HTTPS domain names that can be protected by the instance.|10 **Note:** Contains only one top-level domain and the subdomains or wildcard domains of this top-level domain.
 ...
 | -   For Standard Function Plan: 45 USD/month for every 10 domain names
-   For Enhanced Function Plan: 75 USD/month for every 10 domain names

 **Note:** Every 10 protected domain names contain only one top-level domain and the subdomains or wildcard domains of this top-level domain.
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/79667/156515997938045_en-US.png)
