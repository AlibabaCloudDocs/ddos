...
|API|Description|
|---|-----------|
|[DescribeDomains](/intl.en-US/API reference/Anti-DDoS Pro & Premium/Website configuration/DescribeDomains.md)|Queries the domain names that are added to the Anti-DDoS Pro or Anti-DDoS Premium instance.|
...
|[ModifyBlockStatus](/intl.en-US/API reference/Anti-DDoS Pro & Premium/Protection for infrastructure/ModifyBlockStatus.md)|Modifies the Diversion from Origin Server configurations of one or more Anti-DDoS Pro instances.|
...
|[DescribeNetworkRuleAttributes](/intl.en-US/API reference/Anti-DDoS Pro & Premium/Protection for non-website services/DescribeNetworkRuleAttributes.md)|Queries the mitigation settings for the port forwarding rule of a non-website service, which include session persistence and DDoS mitigation policies.|
|[ModifyNetworkRuleAttribute](/intl.en-US/API reference/Anti-DDoS Pro & Premium/Protection for non-website services/ModifyNetworkRuleAttribute.md)|Modifies the session persistence policy for the port forwarding rule of a non-website service.|
...
|[DescribeTagResources](/intl.en-US/API reference/Anti-DDoS Pro & Premium/Tag/DescribeTagResources.md)|Queries the tags bound with resources.|
...
|[CreateAsyncTask](/intl.en-US/API reference/Anti-DDoS Pro & Premium/System configuration and logs/CreateAsyncTask.md)|Creates an asynchronous export task to export forwarding rules for websites, port forwarding rules, session persistence and health check configurations, DDoS mitigation policies, IP address blacklist, or IP address whitelist.|
