# Error codes {#reference_zdg_np5_jgb .reference}
...
|ddos\_coop3203|start time must be earlier than end time|The error message returned when the start time is no earlier than the end time.|
