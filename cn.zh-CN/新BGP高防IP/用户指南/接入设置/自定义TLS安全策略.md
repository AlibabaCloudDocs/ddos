...
-   已上传对应的HTTPS证书（具体操作请参见[上传HTTPS证书](cn.zh-CN/新BGP高防IP/用户指南/接入设置/上传HTTPS证书.md#)）。
...
3.  选择已添加的网站业务配置，单击其证书状态列中的**TLS安全策略**。 
    ...
    ![TLS安全策略](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/776342/156575155750664_zh-CN.png)
...
4.  在**TLS安全策略配置**对话框中，选择**TLS版本**和**加密套件**。 
    ...
    ![TLS安全策略配置](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/776342/156575155750665_zh-CN.png)
